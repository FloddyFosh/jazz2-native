...
void main() {
	...
	inline constexpr ShaderCompiler::ProgramVariant Resize3xBrz_Variants[] = {
		{ "", "",
			...
			Resize3xBrz_VsDxbc, Resize3xBrz_VsDxbcSize, Resize3xBrz_FsDxbc, Resize3xBrz_FsDxbcSize,
#else
			nullptr, nullptr,
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_VULKAN)
			Resize3xBrz_VkVs, Resize3xBrz_VkVsSize, Resize3xBrz_VkFs, Resize3xBrz_VkFsSize,
#else
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_METAL)
			Resize3xBrz_VsMsl, Resize3xBrz_FsMsl },
#else
			nullptr, nullptr },
#endif
	};
