...
void main() {
	...
	inline constexpr ShaderCompiler::ProgramVariant ResizeHQ2x_Variants[] = {
		{ "", "",
			...
			ResizeHQ2x_VsDxbc, ResizeHQ2x_VsDxbcSize, ResizeHQ2x_FsDxbc, ResizeHQ2x_FsDxbcSize,
#else
			nullptr, nullptr,
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_VULKAN)
			ResizeHQ2x_VkVs, ResizeHQ2x_VkVsSize, ResizeHQ2x_VkFs, ResizeHQ2x_VkFsSize,
#else
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_METAL)
			ResizeHQ2x_VsMsl, ResizeHQ2x_FsMsl },
#else
			nullptr, nullptr },
#endif
	};
