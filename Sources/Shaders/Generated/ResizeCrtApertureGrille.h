// Generated by ShaderCompiler from ResizeCrtApertureGrille.shader. Do not edit manually.
#pragma once
...
void main() {
	...
	inline constexpr ShaderCompiler::Uniform ResizeCrtApertureGrille_Uniforms[] = {
		{ "uProjectionMatrix", ShaderCompiler::UniformType::Mat4, 0 },
		{ "uViewMatrix", ShaderCompiler::UniformType::Mat4, 0 },
	};

	inline constexpr ShaderCompiler::BlockMember ResizeCrtApertureGrille_Block0_Members[] = {
	...
	inline constexpr ShaderCompiler::UniformBlock ResizeCrtApertureGrille_Blocks[] = {
		{ "InstanceBlock", 112, 0, 4, ResizeCrtApertureGrille_Block0_Members },
	};

	inline constexpr ShaderCompiler::TextureBinding ResizeCrtApertureGrille_Textures[] = {
		{ "uTexture", 0 },
	};
...
#endif
#if defined(WITH_RHI_D3D11)
			ResizeCrtApertureGrille_VsHlsl, ResizeCrtApertureGrille_FsHlsl,
			ResizeCrtApertureGrille_VsDxbc, ResizeCrtApertureGrille_VsDxbcSize, ResizeCrtApertureGrille_FsDxbc, ResizeCrtApertureGrille_FsDxbcSize,
#else
			nullptr, nullptr,
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_VULKAN)
			ResizeCrtApertureGrille_VkVs, ResizeCrtApertureGrille_VkVsSize, ResizeCrtApertureGrille_VkFs, ResizeCrtApertureGrille_VkFsSize,
#else
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_METAL)
			ResizeCrtApertureGrille_VsMsl, ResizeCrtApertureGrille_FsMsl },
#else
			nullptr, nullptr },
#endif
	};

	inline constexpr ShaderCompiler::Program ResizeCrtApertureGrille = { "ResizeCrtApertureGrille", 0, 1, ResizeCrtApertureGrille_Variants };
}
#endif
