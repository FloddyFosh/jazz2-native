...
void main() {
	...
	inline constexpr ShaderCompiler::ProgramVariant CombineWithWater_Variants[] = {
		{ "", "",
			...
			CombineWithWater_VsDxbc, CombineWithWater_VsDxbcSize, CombineWithWater_FsDxbc, CombineWithWater_FsDxbcSize,
#else
			nullptr, nullptr,
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_VULKAN)
			CombineWithWater_VkVs, CombineWithWater_VkVsSize, CombineWithWater_VkFs, CombineWithWater_VkFsSize,
#else
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_METAL)
			CombineWithWater_VsMsl, CombineWithWater_FsMsl },
#else
			nullptr, nullptr },
#endif
	};
