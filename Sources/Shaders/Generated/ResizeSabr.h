...
void main() {
	...
	inline constexpr ShaderCompiler::ProgramVariant ResizeSabr_Variants[] = {
		{ "", "",
			...
			ResizeSabr_VsDxbc, ResizeSabr_VsDxbcSize, ResizeSabr_FsDxbc, ResizeSabr_FsDxbcSize,
#else
			nullptr, nullptr,
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_VULKAN)
			ResizeSabr_VkVs, ResizeSabr_VkVsSize, ResizeSabr_VkFs, ResizeSabr_VkFsSize,
#else
			nullptr, 0, nullptr, 0,
#endif
#if defined(WITH_RHI_METAL)
			ResizeSabr_VsMsl, ResizeSabr_FsMsl },
#else
			nullptr, nullptr },
#endif
	};
