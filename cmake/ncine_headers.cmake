...
if(NCINE_PREFERRED_RHI STREQUAL "Software")
	list(APPEND HEADERS
		...
		${NCINE_SOURCE_DIR}/nCine/Graphics/RHI/Software/SwUniformCache.h
		${NCINE_SOURCE_DIR}/nCine/Graphics/RHI/Software/SwVertexFormat.h
		# Offline-transpiled GLSL-to-C++ software fragment functions (generated by ShaderCompiler)
		${NCINE_SOURCE_DIR}/Shaders/Generated/SwGeneratedShaders.h
	)
endif()

# Console fixed-function backends: the aggregate effect headers transpiled from the shaders'
# fixed_function blocks (generated by ShaderCompiler --emit-fixed-function, committed like
# SwGeneratedShaders.h; each is included by its backend's device file only)
if(NCINE_PREFERRED_RHI STREQUAL "GX")
	list(APPEND HEADERS
		${NCINE_SOURCE_DIR}/Shaders/Generated/GxGeneratedEffects.h
	)
